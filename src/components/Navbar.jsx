...
//           <li>
//             <a href="/" className="hover:text-[#6B21A8] transition-colors">
//               Home
//             </a>
//           </li>
//           <li>
...
export default function Navbar() {
  ...
  return (
    <div className="relative font-['Lato']">
      ...
      >
        {/* Logo - Increased size from h-10 to h-16 (both height and width scale proportionally) */}
        <img
          src="/assets/Logo.png"
          alt="JuristQuest Logo"
      ...
      {mobileMenuOpen && (
        <div className="fixed top-0 left-0 w-full h-screen z-50 bg-white text-black p-6 transition-all duration-300 animate-fadeDown overflow-y-auto">
          <div className="flex justify-between items-center mb-6">
            {/* Mobile menu logo - also increased proportionally */}
