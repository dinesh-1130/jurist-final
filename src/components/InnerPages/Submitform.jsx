...
const FileUploadField = memo(
  ({ label, name, required = true, onChange, selectedFile, error }) => (
    <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
...
const QRCodeCard = ({ onQRClick }) => (
  <div className="bg-gradient-to-r from-purple-50 to-violet-50 rounded-lg p-6 shadow-sm border border-purple-200 mb-6">
    <div className="flex items-center mb-4">
      <QrCode className="text-[#6B21A8] mr-3" size={24} />
      <h3 className="text-lg font-semibold text-[#6B21A8]">Scan Here to Pay</h3>
    </div>
    <div className="bg-white rounded-lg p-4 shadow-sm">
      <div className="flex flex-col md:flex-row items-center gap-4">
        <div className="flex-1">
          <p className="text-gray-700 mb-2">
            Scan the QR code below to make your payment instantly using any UPI
            app.
          </p>
          <p className="text-sm text-gray-600">
            After payment, please upload the screenshot as proof of payment
            below.
          </p>
        </div>
        <div className="flex-shrink-0">
          <div
            className="cursor-pointer transform hover:scale-105 transition-transform duration-200 bg-white p-2 rounded-lg shadow-md border border-gray-200"
            onClick={onQRClick}
          >
            <img
              src="/assets/qr.jpg"
      ...
      <div className="relative bg-white rounded-2xl p-8 shadow-2xl max-w-md mx-4 transform transition-all duration-300 scale-100">
        ...
        <div className="text-center">
          ...
          <div className="mb-6">
            ...
            <div className="mx-auto bg-white p-4 rounded-lg shadow-lg border border-gray-200">
              <img
                src="/assets/qr.jpg"
                alt="QR Code for Payment"
      ...
      <div className="relative bg-white rounded-2xl p-8 shadow-2xl max-w-md mx-4 transform transition-all duration-300 scale-100">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">
            Your registration has been submitted successfully. Post confirmation
...
export default function RegistrationForm() {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      const idCardBase64 = formData.idCard
        ? await toBase64(formData.idCard)
        : "";
      const proofBase64 = formData.proofOfPayment
        ? await toBase64(formData.proofOfPayment)
        : "";
    ...
    <div className="min-h-screen pt-[100px] bg-[#f9f9ff]">
      <div className="max-w-4xl mx-auto py-8 px-4">
        ...
        <div className="space-y-6">
          ...
          />
          <InputField
            label="Speaker 2 Email ID"
            name="speaker2Email"
            type="email"
            value={formData.speaker2Email}
            onChange={handleInputChange}
            error={errors.speaker2Email}
          />
          ...
          />
          <InputField
            label="Researcher Email ID"
            name="researcherEmail"
            type="email"
            value={formData.researcherEmail}
            onChange={handleInputChange}
            error={errors.researcherEmail}
          />
          ...
          <div className="pt-4">
            <label className="flex items-start space-x-3 cursor-pointer">
              ...
              <div className="text-sm text-gray-600 leading-relaxed max-h-48 overflow-y-auto border border-gray-200 rounded-lg p-4 bg-gray-50">
                <div className="font-medium text-[#6B21A8] mb-3">
                  Disclaimer for JuristQuest - Moot Court Competition
                  Registration: <span className="text-red-500">*</span>
                </div>
                <div className="space-y-3">
                  <p>
                    By registering for the JuristQuest - Moot Court Competition,
                  ...
                  <div>
                    ...
                    purpose of processing your registration and ensuring smooth
                    participation in the Moot Court Competition. Your personal
                    details will not be shared with third parties without your
                  ...
                  <div>
                    ...
                    You confirm that all details provided during the
                    registration process are accurate and complete to the best
                    of your knowledge. Any false or misleading information may
                  ...
                  <div>
                    ...
                    The organizing committee reserves the right to conduct
                    background verification with the respective class teacher or
                    institution to confirm the authenticity of the
                    participant(s). Any instance of forgery or misrepresentation
                    will result in immediate disqualification of the entire team
                  ...
                  <div>
                    ...
                    By registering, you give your consent to receive
                    communication related to the competition, including but not
                    limited to event schedules, updates, and announcements. You
                    may opt-out of non-essential communications at any time by
                  ...
                  <div>
                    ...
                    By participating in the event, you grant the organizers the
                    right to record and photograph the event. These images and
                    recordings may be used for promotional, educational, or
                    other purposes related to the competition. If you do not
                    wish to be photographed or recorded, please inform the
                    organizers in advance.
                  </div>

                  <div>
                    <span className="font-medium">Liability Waiver:</span> The
                    event organizers are not liable for any personal injuries,
                    damages, or losses incurred during your participation in the
                    competition. By registering, you agree to assume full
                    responsibility for your actions and safety.
                  </div>

                  <div>
                    <span className="font-medium">Intellectual Property:</span>{" "}
                    All materials submitted as part of the competition are your
                    intellectual property, but the organizers reserve the right
                    to use, publish, or distribute any content related to the
                    competition for promotional purposes.
                  </div>

                  <div>
                    <span className="font-medium">Compliance with Rules:</span>{" "}
                    By registering, you agree to comply with all competition
                    rules and guidelines set forth by the event organizers.
                    Failure to do so may result in disqualification from the
                    competition.
                  </div>

                  <div>
                    <span className="font-medium">Modification of Terms:</span>{" "}
                    The event organizers reserve the right to modify or update
                    these terms and conditions at any time. Any changes will be
                    communicated to registered participants in a timely manner.
                  </div>

                  <p className="font-medium text-gray-800 pt-2">
                    By submitting this registration form, you agree to all the
      ...
      {/* QR Code Modal */}
      <QRModal isVisible={showQRModal} onClose={() => setShowQRModal(false)} />
    </div>
  );
}
